...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:esegerberg_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:esegerberg_job_results"
  AWS_SNS_RESTORE_GLACIER_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:esegerberg_restore_glacier_files"
  
  AWS_SNS_JOB_REQUEST_TOPIC_TEST = \
    "arn:aws:sns:us-east-1:659248683008:esegerberg_requests_TEST"
  

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "esegerberg_annotations"
  AWS_DYNAMODB_PARTITION_KEY = "job_id"
  AWS_DYNAMODB_SECONDARY_INDEX = "user_id_index"
  AWS_DYNAMODB_SECONDARY_PARTITION_KEY = "user_id"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "esegerberg@mpcs-cc.com"
